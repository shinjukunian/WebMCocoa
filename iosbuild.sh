...
CONFIGURE_ARGS="--disable-docs
                ...
                --disable-unit-tests"
DIST_DIR="_dist"
FRAMEWORK_DIR="libVPX.framework"
FRAMEWORK_LIB="libVPX.framework/libVPX"
HEADER_DIR="${FRAMEWORK_DIR}/Headers/vpx"
GLOBAL_HEADER_DIR="${FRAMEWORK_DIR}/Headers"
...
#define ${include_guard}
  ...
  for target in ${targets}; do
    ...
    printf "#include \"${target}/vpx_config.h\"\n" >> "${config_file}"
...
build_framework() {
  ...
  mkdir -p "${BUILD_ROOT}"
  mkdir -p "${HEADER_DIR}"
#   mkdir -p "${GLOBAL_HEADER_DIR}/vpx_ports"
  ...
  ${LIPO} -create ${lib_list} -output ${FRAMEWORK_DIR}/libVPX
...
#   cp -p "$LIBVPX_SOURCE_DIR/tools_common.h" "${GLOBAL_HEADER_DIR}"
#   cp -p "$LIBVPX_SOURCE_DIR/video_common.h" "${GLOBAL_HEADER_DIR}"
#   cp -p "$LIBVPX_SOURCE_DIR/y4minput.h" "${GLOBAL_HEADER_DIR}"
#   
#   cp -p "$LIBVPX_SOURCE_DIR/vpx_ports/msvc.h" "${GLOBAL_HEADER_DIR}/vpx_ports"
#   cp -p "${BUILD_ROOT}/${target}/vpx_version.h" "${HEADER_DIR}"
