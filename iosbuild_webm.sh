...
cp "${OUTDIR}/${TARGETDIR}/WebM" "${OUTDIR}/WebM.a"

eval xcodebuild -create-xcframework -library "${OUTDIR}/WebM.a" -headers "${OUTDIR}/${TARGETDIR}/Headers/" -output "${OUTDIR}/WebM.xcframework"
